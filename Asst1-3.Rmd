...
**Due Sunday, February 14 @ midnight through Github**
...
5. Include an updated final multiivariable logistic regression model to address question the question and interpret the results. Remember to use the function `glm` as shown in the slides from today's class.
